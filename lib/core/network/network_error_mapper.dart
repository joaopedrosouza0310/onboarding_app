...
class NetworkErrorMapper {
  ...
  static AppException _mapStatusCode(DioException exception) {
    ...
    return switch (statusCode) {
      ...
      404 => const ServerException(message: 'Resource not found', statusCode: 404),
      409 => ServerException(message: message, statusCode: 409),
      422 => ServerException(message: message, statusCode: 422),
      500 => const ServerException(message: 'Internal server error', statusCode: 500),
      502 => const ServerException(message: 'Bad gateway', statusCode: 502),
      503 => const ServerException(message: 'Service unavailable', statusCode: 503),
      _ => ServerException(
        message: message,
